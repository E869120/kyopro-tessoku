...
|:---|:---|:---|:---|:---|:---|
| p.171 | 5.4 節／右図 | - | a^2 から a^3 に向かう点線矢印を入れる | - | - |
...
| p.257 | 7.2 節／4 行目 | 2 以上 N-1 以下の整数 L, R | 2 以上 N 以下の整数 L, R | - | - |
...
| p.289 | 7 章のまとめ／7.3 節 | 悪化させる変更を許す | 悪化させる変更を許す（改行） | - | - |
