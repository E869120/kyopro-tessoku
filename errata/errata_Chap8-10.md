...
|:---|:---|:---|:---|:---|:---|
| p.313 | 8.5 節／応用問題クエリ 1 | 整数 x がと書かれたカードが | 整数 x と書かれたカードが | - | 6 刷で修正 |
...
| p.336 | 8.9 節／応用問題 | - | <code>ただし、配列 A は 1 以上 N 以下の整数を並べ替えたものとなっています</code>を追記 | - | 6 刷で修正 |
...
| p.354 | 9.2 節／図の 3 コマ目 | 頂点 1 に隣接する白色頂点は | 頂点 2 に隣接する白色頂点は | - | 6 刷で修正 |
