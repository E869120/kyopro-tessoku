**重要：この書籍は好評につき Amazon で完売状態になっています。honto にはまだ在庫がありますので、ネット書店で購入したい方は honto をご活用ください。なお、Amazon の在庫は重版により 10/1～14 頃に復活する予定です。**

**9/29 23:30 更新：honto でも完売しました。本を入手したい場合は、リアル書店での購入をご検討ください。**
...
なお、本のリンクは以下の通りです。現在ネット書店に在庫がない状態となっておりますので、本を入手したい場合はリアル書店で購入するようお願いします。
...
章ごとの解説や C++ のソースコード・1～3 章の Python のソースコードは以下のリンクから閲覧できます。 
なお、4 章以降の Python のソースコードは 9/30 頃までお待ちください。
